   ...
   try
   {
      ...
      if( chainbase_flags & chainbase::database::read_write )
      {
         ...
         if( head_block_num() )
         {
            ...
            << " blk(bool): " << head_block.valid();
            // This assertion should be caught and a reindex should occur
            if (head_block.valid())
                std::cout << " hblk: " << head_block->id()
                << "hbl(db): " << head_block_id();
            std::cout << '\n';
      ...
      with_read_lock( [&]()
      {
         init_hardforks(fc::time_point::now()); // Writes to local state, but reads from db
      });
   }
       ...
       try
       {
          ...
          for( const auto& account : snapshot.accounts )
          {
             ...
             create_or_modify< witness_object, by_name >( *this, account.name, [&]( witness_object& w )
             {
                ...
                w.hardfork_time_vote = snapshot.timestamp;
             });

             modify( get_witness_schedule_object(), [&]( witness_schedule_object& wso )
             {
                 if( wso.num_scheduled_witnesses < STEEMIT_MAX_WITNESSES )
                 {
                    wso.current_shuffled_witnesses[wso.num_scheduled_witnesses++] = account.name;
                 }
             } );
          }
          modify( get_dynamic_global_properties(), [&]( dynamic_global_property_object& gpo )
          {
              gpo.time = snapshot.timestamp;
          //    gpo.last_irreversible_block_num = 0;
          //    gpo.head_block_id = snapshot.head_block_id;
          //    gpo.head_block_number = snapshot.head_block_num;
          ...
          validate_invariants();
          init_hardforks(snapshot.timestamp);
       }
       FC_CAPTURE_AND_RETHROW();
    });
}
   ...
   while( itr != next_block.extensions.end() )
   {
      switch( itr->which() )
      {
         ...
         case 2: // hardfork_version vote
         {
            ...
            std::cout << __PRETTY_FUNCTION__
            << "witness: " << fc::string(next_block.witness)
...
void database::init_hardforks(fc::time_point_sec start_time)
{
   _hardfork_times[ 0 ] = start_time;
   _hardfork_versions[ 0 ] = hardfork_version( 0, 0 );
   FC_ASSERT( STEEMIT_HARDFORK_0_1 == 1, "Invalid hardfork configuration" );
   _hardfork_times[ STEEMIT_HARDFORK_0_1 ] = ( start_time + STEEMIT_HARDFORK_0_1_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_2 ] = ( start_time + STEEMIT_HARDFORK_0_2_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_3 ] = ( start_time + STEEMIT_HARDFORK_0_3_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_4 ] = ( start_time + STEEMIT_HARDFORK_0_4_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_5 ] = ( start_time + STEEMIT_HARDFORK_0_5_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_6 ] = ( start_time + STEEMIT_HARDFORK_0_6_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_7 ] = ( start_time + STEEMIT_HARDFORK_0_7_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_8 ] = ( start_time + STEEMIT_HARDFORK_0_8_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_9 ] = ( start_time + STEEMIT_HARDFORK_0_9_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_10 ] = ( start_time + STEEMIT_HARDFORK_0_10_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_11 ] = ( start_time + STEEMIT_HARDFORK_0_11_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_12 ] = ( start_time + STEEMIT_HARDFORK_0_12_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_13 ] = ( start_time + STEEMIT_HARDFORK_0_13_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_14 ] = ( start_time + STEEMIT_HARDFORK_0_14_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_15 ] = ( start_time + STEEMIT_HARDFORK_0_15_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_16 ] = ( start_time + STEEMIT_HARDFORK_0_16_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_17 ] = ( start_time + STEEMIT_HARDFORK_0_17_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_18 ] = ( start_time + STEEMIT_HARDFORK_0_18_TIME );
   ...
   _hardfork_times[ STEEMIT_HARDFORK_0_19 ] = ( start_time + STEEMIT_HARDFORK_0_19_TIME );
