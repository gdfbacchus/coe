   ...
   if( itr == comment_vote_idx.end() )
   {
      ...
      **/
      _db.create<comment_vote_object>( [&]( comment_vote_object& cv ){
         ...
         {
            if( comment.created < (_db._hardfork_times[ STEEMIT_HARDFORK_0_6 ] - STEEMIT_HARDFORK_0_6_REVERSE_AUCTION_TIME) ) {
               ...
               if( _db.has_hardfork( STEEMIT_HARDFORK_0_17__774 ) )
               {
                  ...
                  auto curve = !_db.has_hardfork( STEEMIT_HARDFORK_0_19__1052 ) && comment.created > (_db._hardfork_times [STEEMIT_HARDFORK_0_19] - STEEMIT_HF_19_SQRT_PRE_CALC)
            ...
            if( _db.head_block_time() > (_db._hardfork_times[ STEEMIT_HARDFORK_0_6 ] - STEEMIT_HARDFORK_0_6_REVERSE_AUCTION_TIME) )  /// start enforcing this prior to the hardfork
            {
